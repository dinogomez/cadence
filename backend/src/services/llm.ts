...
Make numbers realistic (account numbers 8 digits, order numbers like ORD-28491, dates in Month DD YYYY format, dollar amounts with cents). Use the customer's name where relevant.`
    }],
